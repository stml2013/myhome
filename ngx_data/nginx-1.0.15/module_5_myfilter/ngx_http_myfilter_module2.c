...
static ngx_http_module_t  ngx_http_myfilter_module_ctx =
{
    ...
    ngx_http_myfilter_create_loc_conf,     /* create_loc_conf方法 */
    ngx_http_myfilter_merge_loc_conf       /*merge_loc_conf方法*/
};
...
ngx_http_myfilter_header_filter(ngx_http_request_t *r)
{
    ...
    ngx_log_error(NGX_LOG_EMERG, r->connection->log, 0, "OUT_STATUS = %d xxxxxxx ", r->headers_out.status);//调试
